...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7891845883').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003058315935').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002699575817') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1003083785057')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://angan:angan@angan.zt9nvpm.mongodb.net/?retryWrites=true&w=majority&appName=Angan")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/moviemanians04')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/moviemanians1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'botsupporthd') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://anganbk4')
